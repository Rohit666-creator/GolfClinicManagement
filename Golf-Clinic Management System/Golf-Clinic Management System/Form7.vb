...
Public Class Form7
    ...
    Private Sub ComboBox1_Click(sender As Object, e As System.EventArgs) Handles ComboBox1.Click
        ...
        'for fetching Player Id into Driving Range session
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles ComboBox1.SelectedIndexChanged
        ...
        'for fetching Player Name & Batch No into Driving Range Session
        Dim cmb As String
        cmb = ComboBox1.Text
        ...
        'for fetching Coach Id and Coach Name into Driving Range Session
        Dim bno As String
        bno = TextBox3.Text
